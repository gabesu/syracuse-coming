...
console.log("Check hero.js for snippets");
/*
    * TimelineMax usage
...
! Then call headerText.lines to use
*/
...
// needed for selecting pseudo-elements like :before or :after
var countdown = document.querySelector(".countdown");
var counter = document.querySelector(".counter");

var underline = _CSSRulePlugin.default.getRule("h2:after"); // Split h2 into words using Typesplit


var headerText = new SplitType("h2", {
  split: "words"
...
tl.from(counter, 1, {
  ...
  y: "-48px",
  ease: Back.easeOut.config(1.2)
}, "+=0.3").staggerFrom(headerText.words, 0.5, {
  y: "20px",
  opacity: 0,
  ease: Back.easeOut.config(1.2)
}, 0.1).staggerFrom("li", 0.8, {
  y: "20px",
  opacity: 0,
  ease: Back.easeOut.config(1.2)
}, 0.4).from(underline, 0.3, {
  cssRule: {
    width: "0"
  }
});
},{"gsap":"node_modules/gsap/index.js","gsap/CSSRulePlugin":"node_modules/gsap/CSSRulePlugin.js","typesplit":"node_modules/typesplit/splittype.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./js/hero.js");

require("./js/animation");
},{"./js/hero.js":"js/hero.js","./js/animation":"js/animation.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/switch.e31bb0bc.js.map