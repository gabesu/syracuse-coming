...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"images/grunge-bg@2x.png":[function(require,module,exports) {
module.exports = "/../grunge-bg@2x.def8240c.png";
},{}],"fonts/Hurme.otf":[function(require,module,exports) {
module.exports = "/../Hurme.87411e17.otf";
},{}],"fonts/Hurme-Light.otf":[function(require,module,exports) {
module.exports = "/../Hurme-Light.19fdd064.otf";
},{}],"fonts/Hurme-SemiBold.otf":[function(require,module,exports) {
module.exports = "/../Hurme-SemiBold.e363d4f1.otf";
...
},{"./../fonts/Hurme.otf":[["Hurme.87411e17.otf","fonts/Hurme.otf"],"fonts/Hurme.otf"],"./../fonts/Hurme-SemiBold.otf":[["Hurme-SemiBold.e363d4f1.otf","fonts/Hurme-SemiBold.otf"],"fonts/Hurme-SemiBold.otf"],"./../fonts/Hurme-Light.otf":[["Hurme-Light.19fdd064.otf","fonts/Hurme-Light.otf"],"fonts/Hurme-Light.otf"],"./../images/grunge-bg@2x.png":[["grunge-bg@2x.def8240c.png","images/grunge-bg@2x.png"],"images/grunge-bg@2x.png"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/gsap/TweenLite.js":[function(require,module,exports) {
...
},{"./TweenLite.js":"node_modules/gsap/TweenLite.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"node_modules/typesplit/splittype.js":[function(require,module,exports) {
var define;
/**
 * SplitType
...
// ! NOT WORKING: needed for selecting pseudo-elements like :before or :after
var navBtn = document.querySelector(".nav-btn");
var logo = document.querySelector(".logo");
var countdown = document.querySelector(".countdown");
var counter = document.querySelector(".counter");
var content = document.querySelector(".content");
var header = document.querySelector(".caption h1");
var caption = document.querySelector(".caption p");

var underline = _CSSRulePlugin.CSSRulePlugin.getRule("h1:after");

var greyDots = document.querySelectorAll(".grey-dots g");
var orangeDots = document.querySelectorAll(".orange-dots g"); // Split h2 into words using Typesplit

var headerText = new SplitType(header, {
  split: "words"
}); // Split h2 into words using Typesplit

var captionText = new SplitType(caption, {
  split: "lines"
}); // Create menu timeline instance

var mainTl = new _gsap.TimelineMax();
mainTl.from(counter, 1, {
  y: "10px",
  opacity: 0,
  ...
  ease: Power4.easeOut
}).staggerFrom(headerText.words, 0.5, {
  y: "20px",
  opacity: 0,
  ease: Back.easeOut.config(1.2)
}, 0.1).from(underline, 0.3, {
  cssRule: {
    width: "0"
  }
}).staggerFrom(captionText.lines, 1, {
  y: "20px",
  opacity: 0,
  ease: Back.easeOut.config(1.2)
}, 0.5).to(content, 1, {
  ...
  autoAlpha: 0,
  ease: Power4.easeOut
}).staggerFrom(orangeDots, 2, {
  scale: 0,
  ease: Elastic.easeOut.config(1, 0.3)
}, 0.01).staggerFrom(greyDots, 2, {
  scale: 0,
  ease: Elastic.easeOut.config(1, 0.3)
}, 0.01, "-=5");
},{"gsap":"node_modules/gsap/index.js","gsap/CSSRulePlugin":"node_modules/gsap/CSSRulePlugin.js","typesplit":"node_modules/typesplit/splittype.js"}],"js/menu.js":[function(require,module,exports) {
"use strict";
...
var menuHeader = document.querySelector(".nav-menu h3");
var menuLinks = document.querySelectorAll(".nav-menu a");
var menuLine1 = document.querySelector(".menu-line-1");
var menuLine2 = document.querySelector(".menu-line-2"); // Create menu timeline instance

var menuTl = new _gsap.TimelineMax({
  paused: true
...
menuTl.set(navMenu, {
  ...
  delay: 0.1,
  ease: Power2.easeOut
}).staggerFrom(menuLinks, 0.2, {
  y: 20,
  opacity: 0,
  delay: 0.3,
  ease: Power2.easeOut
}, 0.1); // Play animation when the menu icon is clicked
...
},{"gsap":"node_modules/gsap/index.js"}],"js/illustration.js":[function(require,module,exports) {
"use strict";

var _gsap = require("gsap");

var flowers = document.querySelectorAll(".flower");
var rightHand = document.querySelector(".r-hand");
var leftHand = document.querySelector(".l-hand");
var poster = document.querySelector(".poster"); // Set and play tween for Right Hand on illustration

_gsap.TweenMax.set(rightHand, {
  transformOrigin: "center bottom"
});

var rHand = _gsap.TweenMax.to(rightHand, 2, {
  rotation: 10,
  repeat: -1,
  yoyo: true,
  ease: Back.easeOut.config(1.7)
...
_gsap.TweenMax.set(leftHand, {
  transformOrigin: "right center"
});

var lHand = _gsap.TweenMax.to(leftHand, 2, {
  rotation: -10,
  repeat: -1,
  yoyo: true,
  ease: Back.easeOut.config(1.7)
...
_gsap.TweenMax.set(poster, {
  transformOrigin: "center center"
});

var posterTween = _gsap.TweenMax.to(poster, 5, {
  y: -5,
  rotation: -2,
  repeat: -1,
  yoyo: true
...
_gsap.TweenMax.set(flowers, {
  transformOrigin: "center center"
});

var flowersTl = new _gsap.TimelineMax({});
flowersTl.staggerTo(flowers, 1, {
  scale: 2,
  repeat: -1,
  yoyo: true
}, 0.5);
flowersTl.play();
var flowerContent = document.querySelector(".flower-content");
flowers.forEach(function (flower) {
  if (window.innerWidth > 900) {
    flower.addEventListener("mouseover", function (e) {
      // console.log(e.clientX, e.clientY);
      var content = flower.getAttribute("data-content");
      var flowerHeight = flower.getBoundingClientRect().height * 2;
      var flowerX = flower.getBoundingClientRect().x;
      var flowerY = flower.getBoundingClientRect().y;
      ...
      flowerContent.style.left = flowerX - 300 + "px"; // if(e.clientX > 800 ){
...
require("./images/grunge-bg@2x.png");

require("./fonts/Hurme.otf");

require("./fonts/Hurme-Light.otf");

require("./fonts/Hurme-SemiBold.otf");
...
require("./js/illustration");
},{"./images/grunge-bg@2x.png":"images/grunge-bg@2x.png","./fonts/Hurme.otf":"fonts/Hurme.otf","./fonts/Hurme-Light.otf":"fonts/Hurme-Light.otf","./fonts/Hurme-SemiBold.otf":"fonts/Hurme-SemiBold.otf","./sass/main.scss":"sass/main.scss","./js/reveal":"js/reveal.js","./js/menu":"js/menu.js","./js/illustration":"js/illustration.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/syracuse-coming.e31bb0bc.js.map